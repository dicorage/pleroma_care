                ...
                <div class="sencare-inner">
                    <div class="row">
                        <div class="col-lg-5 col-md-5 col-sm-12">
                            <figure class="mb-0">
                                <img src="/assets/images/sencare-section-img1.png" alt="" class="img-fluid sencare-inner-img rounded-25">
                            </figure>
                            <div class="green-box position-relative">
                                <div class="img-text-box" data-aos="fade-up">
                                    <ul class="list-unstyled mb-0">
                                        ...
                                        <li><span>+1 (888) 425-7388</span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div id="accordion1">
                                            <div class="accordion-card">
                                                <div class="" id="headingFive">
                                                    <a href="#" class="btn btn-link text-decoration-none collapsed position-relative" data-toggle="collapse" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                                        ...
                                        <div id="accordion2" class="accordion2-p">
                                            <div class="accordion-card">
                                                <div class="" id="headingSix">
                                                    <a href="#" class="btn btn-link text-decoration-none collapsed position-relative" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
